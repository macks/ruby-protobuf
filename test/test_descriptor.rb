...
=begin
    ...
    tutorial_proto.package = :Tutorial
    ...
    person_name_proto.label = LABEL_REQUIRED
    person_name_proto.type = TYPE_STRING
    ...
    person_id_proto.label = LABEL_REQUIRED
    person_id_proto.type = TYPE_INT32
    ...
    person_email_proto.label = LABEL_OPTIONAL
    person_email_proto.type = TYPE_STRING
    ...
    person_phone_number_number_proto.label = LABEL_REQUIRED
    person_phone_number_number_proto.type = TYPE_STRING
    ...
    person_phone_number_type_proto.label = LABEL_OPTIONAL
    person_phone_number_type_proto.type = TYPE_ENUM
    ...
    person_phone_phone_number_proto = FieldDescriptionProto.new
    person_proto.field << person_phone_phone_number_proto
    person_phone_phone_number_proto.label = LABEL_REPEATED
    person_phone_phone_number_proto.type = TYPE_MESSAGE
    ...
    address_book_person_proto.label = LABEL_REPEATED
    address_book_person_proto.type = TYPE_MESSAGE
