...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_descriptor.rb", "test/test_ruby_protobuf.rb", "test/test_message.rb", "test/test_optional_field.rb", "test/test_repeated_types.rb", "test/test_extension.rb", "test/test_addressbook.rb", "test/test_types.rb", "test/test_standard_message.rb", "test/test_parse.rb", "test/test_compiler.rb", "test/test_serialize.rb"]
